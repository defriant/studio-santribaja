...
function todayVisitor() {
    ajaxRequest
        ...
        .then((result) => {
            ...
            let ctx = document
                .getElementById("today-visitor-chart")
                .getContext("2d");
...
function yearlyVisitor(year) {
    ajaxRequest
        ...
        .then((result) => {
            ...
            let ctx = document
                .getElementById("years-visitor-chart")
                .getContext("2d");
    ...
    ajaxRequest
        ...
        .then((result) => {
            ...
            $.each(result.countries, function (i, v) {
                countryVisitingData =
                    countryVisitingData +
                    `<tr data-country="${v.country}" class="${
                        countryVisitingRowActive == v.country
                            ? "row-active"
                            : ""
                    }">
                                                            <td>${v.iso}</td>
...
function visitorUpdate() {
    ajaxRequest
        ...
        .then((result) => {
            ...
            todayChart.data.datasets[1].data = avgDataset;
            todayChart.options.scales.y.suggestedMax =
                todayHighest + todayHighest / 4;
            todayChart.update();
            ...
            yearChart.options.scales.y.suggestedMax =
                yearlyHighest + yearlyHighest / 4;
            yearChart.update();
